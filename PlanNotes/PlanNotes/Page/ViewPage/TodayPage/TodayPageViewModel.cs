...
namespace PlanNotes.ViewModel
{
    ...
    {
        public TodayPageViewModel(IDataService dataService, INavigationService navigationService, IDialogService dialogService) : base(dataService, navigationService, dialogService)
        {
            ...
            {
                if (note.NoteDueDate.Date == DateTime.Now.ToLocalTime().Date)
                    NotesToday.Add(note);
            }
