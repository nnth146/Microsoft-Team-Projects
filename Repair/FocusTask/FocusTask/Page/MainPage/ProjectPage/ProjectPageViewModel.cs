...
namespace FocusTask.ViewModel
{
    ...
    {
        public ProjectPageViewModel(IDataService dataService, INavigationService navigationService, IDialogService dialogService) : base(dataService, navigationService, dialogService)
        {
            CurrentProject = WeakReferenceMessenger.Default.Send<SelectedProjectRequestMessage>().Response;
        ...
        public DateTimeOffset? DueDateMission { get; set; }

        private RelayCommand _addMissionCommand;
        public RelayCommand AddMissionCommand => _addMissionCommand ?? (_addMissionCommand = new RelayCommand(async () =>
        {
        ...
        private void AddMission()
        {
            ...
            {
                Name = MissionName,
                DateTime = DueDateMission.HasValue ? DueDateMission.Value.DateTime : default,
