...
{
    public class TomorrowPageViewModel : ViewModelBase
    {
        public TomorrowPageViewModel(IDataService dataService, INavigationService navigationService, IDialogService dialogService) : base(dataService, navigationService, dialogService)
        {
            GetRawMissions();
            SetupMissions();
            SetupProjects();
        ...
        public void SetupMissions()
        {
            var missions = RawMissions
                ...
                .Where(x => x.DateTime.Value.Date == DateTime.Now.AddDays(1).Date)
                .OrderBy(x => x.Created)
                .ToList();
