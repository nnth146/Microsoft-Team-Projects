...
{
    public class EditServerPageViewModel : ViewModelBase
    {
        public EditServerPageViewModel(IDataService dataService, INavigationService navigationService, IDialogService dialogService, IMessenger messengerService) : base(dataService, navigationService, dialogService, messengerService)
        {
            SelectedPassword = messengerService.Send<SelectedPasswordRequestMessage>().Response as Server;
            Password = new Server();
        ...
        private Server _password;
        public Server Password { get { return _password; } set { SetProperty(ref _password, value); } }

        public Server SelectedPassword { get; set; }
