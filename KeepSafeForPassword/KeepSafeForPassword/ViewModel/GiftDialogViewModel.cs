...
{
    public class GiftDialogViewModel : ViewModelBase
    {
        ...
        public RelayCommand DonateCommand => _donateCommand ?? (_donateCommand = new RelayCommand(async () =>
        {
            ...
            switch (result.Status)
            {
                ...
                case StorePurchaseStatus.Succeeded:
                    await dialogService.showMessageContentDialogAsync($"Thank you!");
                ...
                case StorePurchaseStatus.NetworkError:
                    await dialogService.showMessageContentDialogAsync($"Network Error");
