...
{
    public class ViewSecureNotePageViewModel : ViewDatabasePageViewModel
    {
        public ViewSecureNotePageViewModel(IDataService dataService, INavigationService navigationService, IDialogService dialogService, IMessenger messengerService) : base(dataService, navigationService, dialogService, messengerService)
        {
        }

        public new IEnumerable<Password> FilterPasswords { get; set; } = Account.CurrentAccount.SecureNotes;
