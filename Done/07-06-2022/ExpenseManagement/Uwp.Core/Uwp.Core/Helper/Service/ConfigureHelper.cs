...
namespace Uwp.Core.Helper
{
    public sealed class ConfigureHelper : IDisposable
    {
        ...
        public ConfigureHelper()
        {
            ...
            _projectName = "ExpenseManagement";
        ...
        public void ConfigureDatabase()
        {
            ...
            if(DataContext.Default.Categories.Count() == 0)
            {
                ...
                for (int i = 0; i < nameCategory.Count; i++)
                {
                    ...
                    DataContext.Default.Categories.Add(category);
                    DataContext.Default.SaveChanges();
                }
            }
        }
